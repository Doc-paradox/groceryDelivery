...
const AddressPage = ({ onBack, handleAddressDetailsChange, handleSubmit, addressDetails }) => {
  return (
    <Container maxWidth="sm">
      <Box sx={{ mt: 4 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Button variant="contained" color="secondary" fullWidth sx={{ mt: 2 }} onClick={onBack}>
            Back
          </Button>
        </form>
      </Box>
